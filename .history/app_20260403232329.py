                ...
                second_pass_messages = [
                    {
                        ...
                        "content": (
                            ...
                            "You already have all required information. "
                            "Your job now is ONLY to answer the user's original question clearly and directly. "
                            "Do not search again. "
                            "Do not plan searches. "
                            "Do not output DSML, XML, function call syntax, tool traces, or internal reasoning. "
                            "Do not mention google_search, WINE_TOOLS, invoke, parameter, or function_calls. "
                    ...
                    {
                        "role": "system",
                        "content": f"Search result obtained already:\n{search_result}"
                    },
                    {
                        "role": "user",
                        "content": (
                            "Based only on the information above, give the final user-facing answer now. "
                            "Do not search again. Do not output any tool syntax."
                        )
                    }
                ]
