        ...
        try:
            ...
            if ai_message.tool_calls:
                ...
                messages.append({
                                    "role": "system",
                                    "content": (
                                        "ALL DATA SECURED. Now, combine the real-time search results above with the "
                                        f"user's cellar inventory and preferences for {nickname}. "
                                        "Give your FINAL MW/MS professional analysis. "
                                        "STRICTLY FORBIDDEN: Any more tool calls, DSML tags, or technical reasoning. "
                                        "Speak directly to the user now."
                                    )
                                })
